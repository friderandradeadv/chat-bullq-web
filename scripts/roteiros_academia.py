...
ROTEIROS = {
    ...
    # 1.5 — Suas ferramentas e seus acessos (2:34). SEGUNDA geração: a primeira
    # citava o Cálculo Jurídico externo, que o escritório não usa mais. Agora a
    # narração afirma o contrário — todo cálculo sai das calculadoras do hub.
    'ferramentas': {
        'duracao': 154.0,
        'cenas': [
            ...
            {'t': 13.0, 'tipo': 'cartoes', 'secao': 'O centro de tudo',
             'titulo': 'O hub, em quatro frentes', 'cartoes': [
               ...
               {'icone': 'dinheiro', 'titulo': 'Cálculo',     'sub': 'todo cálculo sai daqui'}], 'aceso': None},
            {'t': 29.5, 'tipo': 'cartoes', 'secao': 'O centro de tudo',
             'titulo': 'O hub, em quatro frentes', 'cartoes': [
               {'icone': 'chat',     'titulo': 'Atendimento', 'sub': 'WhatsApp, pelos agentes de IA'},
               {'icone': 'pasta',    'titulo': 'Kanban',      'sub': 'onde cada processo mora'},
               {'icone': 'relogio',  'titulo': 'Prazos',      'sub': 'agenda e controladoria'},
               {'icone': 'dinheiro', 'titulo': 'Cálculo',     'sub': 'todo cálculo sai daqui'}], 'aceso': 4,
             'rodape': 'Não existe mais calculadora de fora. O número nasce no hub.'},

            {'t': 38.7, 'tipo': 'contraste', 'secao': 'Duas IAs, dois lugares',
             ...
             'direita': {'rotulo': 'Claude, no Cowork', 'titulo': 'Monta a peça', 'manda': True,
                         'linhas': ['Peça, pesquisa e revisão.', 'Roda FORA do hub',
                                    'e não fala com cliente.']}},

            {'t': 62.1, 'tipo': 'lista', 'secao': 'As outras ferramentas',
            ...
            {'t': 72.4, 'tipo': 'lista', 'secao': 'As outras ferramentas',
             'titulo': 'Cada uma com um trabalho', 'itens': ['Google Drive: a pasta de cada cliente e os modelos',
                       'ZapSign: assinatura de contrato e procuração',
                       'ASAAS: cobrança por boleto, PIX e cartão',
                       'PJe, e-SAJ, Projudi e eproc: onde se protocola'], 'aceso': 1},
            {'t': 83.5, 'tipo': 'lista', 'secao': 'As outras ferramentas',
             'titulo': 'Cada uma com um trabalho', 'itens': ['Google Drive: a pasta de cada cliente e os modelos',
                       'ZapSign: assinatura de contrato e procuração',
                       'ASAAS: cobrança por boleto, PIX e cartão',
                       'PJe, e-SAJ, Projudi e eproc: onde se protocola'], 'aceso': 4},

            {'t': 92.7, 'tipo': 'lista', 'secao': 'Seus acessos',
            ...
            {'t': 104.5, 'tipo': 'lista', 'secao': 'Seus acessos',
             'titulo': 'Seis, e nenhum a menos', 'itens': ['E-mail do escritório',
                       'Login no hub',
                       'Google Drive do escritório',
                       'Claude no Cowork, com as skills instaladas',
