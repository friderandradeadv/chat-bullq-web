...
export const REFERENCIAS: RefLegal[] = [
  ...
  { id: 'res_4553', label: 'Res. CMN 4.553/2017', tema: 'segmentação S1–S5 por porte (% do PIB): S1 ≥10%, S2 1–10%, S3 0,1–1%, S4/S5 <0,1% — define completa × simplificada', status: 'validado' },
  ...
  { id: 'cdc_6v', label: 'CDC art. 6º, V', tema: 'direito à modificação de cláusulas desproporcionais / revisão por onerosidade excessiva superveniente', status: 'validado' },
  ...
  // ── Perícia contratual (aula TABM "Como Periciar Contratos") — VALIDADAS na fonte ──
  { id: 'sum_121_stf', label: 'Súmula 121 STF', tema: 'veda a capitalização de juros ainda que convencionada. ⚠️ SUPERADA para contratos do SFN após 31/3/2000 (MP 2.170 + Súm. 539 STJ permitem se pactuada) — aplica-se a contratos fora do SFN / anteriores', status: 'validado' },
  { id: 'sum_539', label: 'Súmula 539 STJ', tema: 'capitalização com periodicidade inferior à anual é lícita nos contratos do SFN após 31/3/2000 SE expressamente pactuada', status: 'validado' },
  { id: 'sum_541', label: 'Súmula 541 STJ', tema: 'taxa anual superior ao DUODÉCUPLO (12×) da mensal já é a pactuação expressa da capitalização', status: 'validado' },
  { id: 'sum_379', label: 'Súmula 379 STJ', tema: 'juros de mora até 1% ao mês nos contratos bancários não regidos por legislação específica', status: 'validado' },
  { id: 'sum_30_472', label: 'Súmulas 30 e 472 STJ', tema: 'comissão de permanência: inacumulável com correção monetária (30) e com juros/multa (472); não pode ultrapassar a soma dos encargos', status: 'validado' },
  { id: 'tema_972', label: 'Tema 972 STJ', tema: 'venda casada (julg. 12/12/2018): o consumidor não pode ser compelido a contratar seguro com a instituição ou seguradora por ela indicada — deve ter liberdade de escolha', status: 'validado' },
  ...
  { id: 'lei_10931', label: 'Lei 10.931/2004, art. 28', tema: 'CCB é título executivo (dívida certa/líquida) — MAS exige os demonstrativos do art. 28 §2º; nasceu p/ superar a Súmula 233 STJ (abertura de crédito não é título)', status: 'validado' },
  { id: 'sum_233', label: 'Súmula 233 STJ', tema: 'contrato de abertura de crédito NÃO é título executivo', status: 'validado' },
  { id: 'cpc_914', label: 'CPC art. 914', tema: 'embargos à execução INDEPENDEM de penhora/depósito/caução; 15 dias úteis; mas só suspendem com garantia + risco (CPC 919 §1º)', status: 'validado' },
  { id: 'cc_205', label: 'CC art. 205', tema: 'prescrição decenal (10 anos) — prazo geral quando a lei não fixa menor', status: 'validado' },
];
