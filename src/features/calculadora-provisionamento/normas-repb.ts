...
export const REFERENCIAS: RefLegal[] = [
  ...
  // ── Perícia contratual (aula TABM "Como Periciar Contratos") — a validar ──
  { id: 'sum_121_stf', label: 'Súmula 121 STF', tema: 'veda a capitalização de juros sem previsão legal/contratual (anatocismo)', status: 'pendente' },
  { id: 'sum_539', label: 'Súmula 539 STJ', tema: 'capitalização mensal é lícita SE expressamente pactuada (contratos pós MP 1.963-17/2000)', status: 'pendente' },
  { id: 'sum_541', label: 'Súmula 541 STJ', tema: 'taxa anual superior a 12× a mensal indica capitalização pactuada', status: 'pendente' },
  { id: 'sum_379', label: 'Súmula 379 STJ', tema: 'juros de mora limitados a 1% ao mês nos contratos bancários', status: 'pendente' },
  { id: 'sum_30_472', label: 'Súmulas 30 e 472 STJ', tema: 'comissão de permanência não pode ser cumulada com outros encargos moratórios', status: 'pendente' },
  { id: 'tema_972', label: 'Tema 972 STJ', tema: 'venda casada: veda impor seguro com seguradora vinculada ao banco', status: 'pendente' },
