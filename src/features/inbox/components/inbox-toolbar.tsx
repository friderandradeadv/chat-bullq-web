...
export function InboxToolbar() {
  ...
  const pillBase =
    'flex items-center gap-1.5 rounded-lg border px-3 py-1 text-[13px] font-medium outline-none transition-colors';
  const pillIdle =
  ...
  return (
    <div className="flex h-10 items-center gap-2 border-b border-zinc-200 bg-white px-4 dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="relative min-w-0 flex-1">
        ...
        <input
          ...
          className="w-full border-0 bg-transparent py-1 pl-8 pr-8 text-sm text-zinc-900 outline-none placeholder:text-zinc-400 dark:text-zinc-100"
        />
        {text && (
          <button
            onClick={() => onSearch('')}
