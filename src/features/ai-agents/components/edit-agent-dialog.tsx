...
import { Trash2, X, Plus, ShieldCheck, History, RotateCcw, Check } from 'lucide-react';
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {!showForm && (
              <button
                ...
                className="shrink-0 rounded-md bg-primary px-2.5 py-1 text-[11px] font-semibold text-white hover:bg-primary/90"
              >
                Salvar versão
              </button>
            )}
            ...
            <div className="mt-2 space-y-2 rounded-md border border-zinc-200 bg-white p-2.5 dark:border-zinc-700 dark:bg-zinc-900">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-md bg-primary px-2.5 py-1 text-[11px] font-semibold text-white hover:bg-primary/90 disabled:opacity-50"
                >
