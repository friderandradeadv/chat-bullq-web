...
export const VERTICAIS_PADRAO = ['RMC/RCC', 'REPB', 'Previdenciário', 'Trabalhista', 'Consumidor', 'Cível', 'Dativos'];
...
export const CORES_VERTICAL: Record<string, string> = {
  ...
  'Consumidor': '#0CA678', 'Cível': '#F08C00', 'Dativos': '#495057', 'Escritório': '#868E96',
};
