...
export type Board = 'pre' | 'judicial' | 'banco' | 'inss' | 'plan' | 'repb';

/** A qual quadro uma fase pertence (repb_* → REPB; plan_* → Planejamento; banco_* → Bancária; inss_admin → INSS; lane pre → Pré; resto → Judicial). */
