...
const GUIAS: { titulo: string; passos: string[]; print?: string }[] = [
  ...
  },
  {
    ...
    passos: [
      ...
      'Clique em Montar a inicial completa. Ele recorta o HISCON e o HISCRE, monta o JG grifado, gera a peça no timbrado, organiza a pasta do réu no Drive e manda o card para Revisão inicial.',
      'Confira as lacunas “[ • ]” na peça antes de protocolar — elas são os campos que faltaram.',
    ],
